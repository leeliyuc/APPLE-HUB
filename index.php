...
<meta name="description" content="获取更多最新短信轰炸接口请访问地址ale.gz.aeert.com，在线短信测压，短信轰炸平台，V8短信">
...
<style>body{ background:#ecedf0 url("img/888.jpg") fixed;background-repeat:no-repeat; background-size:100% 100%;}</style></head>
<body>
<img src="img/888.jpg" alt="Full Background" class="full-bg full-bg-bottom animated pulse " ondragstart="return false;" oncontextmenu="return false;">
<br>
...
<a target="_blank" class="btn btn-info" href="http://wpa.qq.com/msgrd?v=3&uin=3180155362&site=qq&menu=yes"><i class="fa fa-qq"></i> 联系客服</a>
<a target="_blank" class="btn btn-warning" href="https://jq.qq.com/"><i class="fa fa-users"></i> 官方群聊</a>
				...
				<div class="btn-group">
					<a class="btn btn-default" data-toggle="modal" href="#anounce"><i class="fa fa-bullhorn"></i>&nbsp;<span style="font-weight:bold">公告</span></a>
					 	...
					 	<a href="#lxkf" target="_blank" data-toggle="modal" class="btn btn-default"><i class="fa fa-qq"></i>&nbsp;<span style="font-weight:bold">客服</span></a>
			                <div class="btn-group">
                 <a class="btn btn-default" data-toggle="modal" href="http://ale.gz.aeert.com/"><i class="fa fa-users fa-1x"></i>&nbsp;阿乐源码网</a>
				</div>
             </div>
		</div>
	</div>
...
<!--TAB标签开始-->
	<div class="block-title">
        <ul class="nav nav-tabs" data-toggle="tabs">
			...
			<li style="width: 25%;" align="center"><a href="#Substation"><font color="#FF4000"><i class="fa fa-smile-o fa-spin"></i> <b>赞助本站</b></font></a></li>
...
<!--在线下单-->
    <div class="tab-pane active" id="shop">
       <center><div class="shuaibi-tip animated tada  text-center"><i class="fa fa-heart text-danger"></i> <b>有问题请联系站长QQ号或者在本平台留言即可！<i class="fa fa-fw fa-qq text-primary"></i> 3180155362&nbsp;<a href="chat/" data-toggle="modal" class="label label-danger"><font color="#FFFFFF">点击留言</font></a></div><h7><span style="color:#009900;">本站仅供个人测试手机性能使用,严禁商业非法用途!否则后果自负。</span></h7><p><span style="color:#ff0000;">本站永久免费提供使用<br>【平台全自动轰炸,使用过程中请勿关闭网页】<br>详细使用说明请点击上面的 公告 浏览查看</span></p><a href="http://wpa.qq.com/msgrd?v=3&uin=3180155362&site=qq&menu=yes" data-toggle="modal" class="badge badge-primary"><font color="#FFFFFF">【此广告位招租50一月】</font></a><hr></center> </b>		<div id="goodTypeContents">
         ...
         <tbody>
            <tr class="shuaibi-tip animation-bigEntrance">
                <td class="text-center" style="width: 100px;">
                    <img src="http://q4.qlogo.cn/headimg_dl?dst_uin=3180155362&spec=100" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar">
                </td>
                <td>
                    <h4><strong>站长</strong></h4>
					<i class="fa fa-fw fa-qq text-primary"></i> 3180155362<br><i class="fa fa-fw fa-history text-danger"></i>问题请联系客服
                </td>
...
<table class="table table-borderless table-pricing">
            <tbody>
                ...
                <tr>
                    <td><img src="img/999.jpg" width="280" height="380"/></td>
                </tr>
...
<tr><td style="text-align: center;">
				  <a href="" target="_blank" ><span class="STYLE1" style="color: #9f79ee;"><b> 广告位招租<br>廉价广告费<br>欢迎加入我们 </a></b></td><!--2030年11-17日到期-->

				

<td style="text-align: center;">
				  <a href="" rel="nofollow" target="_blank"
					><span class="STYLE1" style="color: #9f79ee;"><b> 广告位招租<br>廉价广告费<br>欢迎加入我们 
</span></a></b>
  </td><td style="text-align: center;">
				 <a href="" rel="nofollow" target="_blank"
					><span class="STYLE1" style="color: #9f79ee;"><b> 广告位招租<br>廉价广告费<br>欢迎加入我们 </span></a></b><!--2020年11/17日到期-->
				</td>
<td style="text-align: center;">
				 <a href=""_blank"
					><span class="STYLE1" style="color: #9f79ee;"> <b> 广告位招租<br>廉价广告费<br>欢迎加入我们 </span></a></b><!--2020年11-19日到期-->
  </td>
...
<td style="text-align: center;">
				 <a href=""_blank"
					><span class="STYLE1" style="color: #FFBF00;"><b>广告位招租<br>廉价广告费<br>快来加入我们吧！</span></a><!--2020年11/22日到期-->
  </td>
<td style="text-align: center;">
				  <a href=""_blank"
					><span class="STYLE1" style="color: #FFBF00;"><b> 广告位招租<br>廉价广告费<br>欢迎加入我们 </span></a><!--2020年11月24日到期-->
  </td><td style="text-align: center;">
				<a href="" rel="nofollow" target="_blank"
					><span class="STYLE1" style="color: #FFBF00;"><b> 广告位招租<br>廉价广告费<br>欢迎加入我们 </span></a><!--2020年10月25日到期-->
  </td><td style="text-align: center;">
				  <a href="http://ale.gz.aeert.com" rel="nofollow" target="_blank"
					><span class="STYLE1"style="color: #FFBF00;"><b>阿乐源码网<br>
<span class="STYLE1"style="color: #FF0000;">阿乐源码网<br></span>
做最好博客</b></span></a><!---->
				</td>
</tr>
    ...
    <div class="panel panel-default">
        <center>
            <div class="panel-body"><span style="font-weight:bold">阿乐源码网<i class="fa fa-heart text-danger"></i> 2020 | </span> <a href="/"><span style="font-weight:bold">ale.gz.aeert.com</span></a> <script language="javascript" type="text/javascript" src="http://js.users.51.la/18759442.js"></script><br>            </div>
    </center></div>
    <!--底部导航-->
</div>
...
<div class="modal fade" align="left" id="lxkf" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
                ...
                <li class="list-group-item">   
				   <div class="media">
				   <span class="pull-left thumb-sm"><img src="img/35e822e5dd88e253c30dc9aba2db19fb.png" alt="..." class="img-circle img-thumbnail img-avatar"></span>
                   <div class="pull-right push-15-t">
                            <a href="http://wpa.qq.com/msgrd?v=3&uin=3180155362&site=qq&menu=yes" target="_blank" class="btn btn-sm btn-info">立即联系</a>
                   </div>
                   <div class="pull-left push-10-t">
                        <div class="font-w600 push-5"><i class="fa fa-fw fa-qq text-primary"></i> 3180155362&nbsp;</div>
                        <div class="font-w600 push-5">地址~hz.1c.cx</div>
                   </div>
				   </div>
                </li>
